...
final class DaemonDomain {
    ...
    private let logger = MainLog.shared.logger(for: .daemon)
    private let daemonPlistName = "com.sonqyau.manis.daemon"
...
@objc protocol ProxyDaemonProtocol {
...
extension DaemonError: LocalizedError {
    ...
    var recoverySuggestion: String? {
        ...
        case .requiresApproval:
            "Open System Settings > Privacy & Security > Developer Tools, then allow \"manis\"."
