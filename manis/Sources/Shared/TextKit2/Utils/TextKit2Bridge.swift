...
public class TextKit2Bridge {
    ...
    public enum PluginFactory {
        ...
        public static func syntaxHighlighting(
            ...
            return HighlightPlugin(language: language, theme: theme, fontSize: fontSize)
        }
    ...
    public enum Utilities {
        ...
        public static func textRange(
            ...
            return NSTextRange(nsRange, in: textContentManager)
        }
        ...
        public static func visibleRange(
            ...
            return layoutManager.textViewportLayoutController.viewportRange
        }
