...
final class SystemProxyDaemon {
  ...
  private let logger = Logger(subsystem: "com.sonqyau.manis.daemon", category: "proxy-settings")
  ...
  func enableProxy(
    ...
    guard let prefRef = SCPreferencesCreate(nil, "manis" as CFString, nil) else {
